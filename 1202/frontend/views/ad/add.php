...
<div class="left">
    <ul>
        <li><a href="<?php echo Url::toRoute('ad/index'); ?>">查看注册字段</a></li>
...
<div class="right">
    <div class="search-box">
        <form action="<?php echo Url::toRoute('ad/add_do'); ?>" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                    <input class="filed-name" name="filed_name" type="text">
                </li>
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" name="defult_val" type="text">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" class="filed-name" name="filed_check[]" placeholder="选项1">
                    <input type="text" class="filed-name" name="filed_check[]" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                    <input type="checkbox" name="ismust" value="0">必填
                </li>
                <li>
                    <span>请选择验证规则：</span>
                    <select name="filed_rule">
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text" name="max_len" value="" placeholder="请输入最小长度">
                    ~
                    <input class="length" type="text" name="min_len" value="" placeholder="请输入最大长度">
                </li>
                <li>
